									...
									<form method="post">
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method" style="padding:10px;">
                            ...
                            <div class="order-details__item">
								...
								<div class="single-item">
                                    ...
                                    <div class="single-item__remove">
                                        <a href="javascript:void(0)" onclick="manage_cart('<?php echo $key?>','remove')"><i class="fa fa-trash fa-2x"></i></a>
                                    </div>
                                </div>
								<?php } ?>
                            </div>
