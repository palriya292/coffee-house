...
<div class="pimg1">
  ...
  <span style="position:relative; color:black; font-size:30px">NEW ARRIVALS</span>

<main>
  <ul class="new-arrivals" style="list-style-type:none; display:grid; grid-template-columns:1fr; grid-gap:10px; margin:20px; position:relative;">
      ...
      <li >
          <a href="#">
              ...
              <a href="product.php?id=<?php echo $list['id']?>">
                  ...
                  <figcaption >
                      <h3 style=" font-size:30px"><?php echo $list['name']?></h3>
                      <p style=" font-size:20px; ">MRP: <?php echo $list['mrp']?></p>
                      <p style=" font-size:20px; ">Price: <?php echo $list['price']?></p>
                  </figcaption>
              </figure>
          </a>
      </li>
  ...
  <div class="pimg3">
    ...
    <p>Farmers are encouraged to join us and we'll provide all necessary tools and monetary funding to end poverty. Giving jobs to the needful and filling happiness with each sip of our customers is the main priority of our company.
     ...
     <ul class="destinations" style="display: inline-flex; list-style-type: none;">
